...
const AchievementIcon = () => (
  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="trophy" className="svg-inline--fa fa-trophy fa-w-18" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
